...
#WHERE
    ...
    orchestrator.py, templates.py, pipeline.py, test files, benchmarks.

#WHAT
    All M1 data models — extraction stage (entities, actions, relations)
    and final scene description (SceneObject, SceneAction, SceneDescription).

#INPUT
    Raw text prompt fields, activity template definitions, object shapes,
    positions, colours, camera motions, etc.

#OUTPUT
    Typed dataclass instances consumed by M2 (ScenePlanner) and M5 (PhysicsEngine).
"""
