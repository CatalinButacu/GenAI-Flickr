...
from .camera import (
    CameraConfig, CinematicCamera, FrameData,
)
from .scene import Scene
from src.shared.mem_profile import profile_memory
from src.shared.constants import DEFAULT_PHYSICS_HZ
...
class Simulator:
    def __init__(self, scene: Scene, camera: CameraConfig = None):
        ...
        # ARCH CONSTRAINT: 240Hz PyBullet simulation rate (paper §3).
        # Sourced from shared constants to avoid duplication.
        self.physics_hz = DEFAULT_PHYSICS_HZ
