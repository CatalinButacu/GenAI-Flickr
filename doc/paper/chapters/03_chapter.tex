...
M6 & Render Engine & Randare SMPL, motion blur, DoF, color grading & aitviewer + OpenCV \\
...
Clipul recuperat este proiectat într-un spațiu de 256 dimensiuni prin \texttt{MotionProjector} (MLP cu SiLU), procesat prin 4 straturi de Mamba \cite{gu2023mamba} (SSM selectiv \cite{gu2022s4}), și proiectat înapoi la 251 dimensiuni (formatul KIT-ML \cite{plappert2016kit}).
...
Cadrele brute din simulare sunt randate prin SMPL \cite{loper2015smpl} via aitviewer \cite{kaufmann2023aitviewer}, apoi procesate prin:
\begin{enumerate}
