...
from src.shared.constants import KIT_ML_BONES as _BONES
from src.modules.render.engine import RenderEngine, RenderSettings

import imageio
import torch
from PIL import Image
from diffusers.models.controlnets.controlnet import ControlNetModel  # type: ignore[import-untyped]
from diffusers.pipelines.controlnet.pipeline_controlnet import StableDiffusionControlNetPipeline  # type: ignore[import-untyped]
from diffusers.schedulers.scheduling_unipc_multistep import UniPCMultistepScheduler  # type: ignore[import-untyped]
...
def main() -> None:
    ...
    processed = engine.process_frames(wrapped)   # apply cinematic post-processing
